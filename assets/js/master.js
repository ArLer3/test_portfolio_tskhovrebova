...
const elements = document.querySelectorAll('.animate-text');
  ...
  elements.forEach(el => {
    ...
    // Animate each element individually using ScrollTrigger
...
gsap.registerPlugin(ScrollTrigger);
  ...
  gsap.to(".rotate-on-scroll", {
    ...
    scrollTrigger: {
      ...
      scrub: 0.5 // <— adds delay/smoothness
    }
  });

gsap.utils.toArray(".img-class").forEach((img, i) => {
  gsap.from(img, {
    rotationY: 90,
    ...
    duration: 1,
    ease: "back.out(1.7)",
    delay: i * 0.2, // delay for one-by-one animation
    scrollTrigger: {
      trigger: img,
      start: "top 80%",
      toggleActions: "play none none none"
